            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" id="imageContainer">
                        <div data-id="0" class="dropzonecontainer col-4 text-center align-items-center mt-2 mb-2" style="position: relative">
                            <div class="col-12 me-2 text-center"><p class="p-2" style="transform: translate(-50%, -50%); top: 0%;  left: 50%;position:absolute;background-color:black;color:#fff;z-index:100000">{{ __('صورة الغلاف') }}</p></div>
                            <x-uploadads maxfiles="1" filename="cover" url="{{ route('ads.cover.upload.submit') }}" />
                        </div>
                        @for($i = 1; $i <=30; $i++)
                            <div data-id="{{$i}}" class="dropzonecontainer col-4 text-center align-items-center mt-2 mb-2">
        ...
        <div class="col-md-8 col-sm-10 col-12 form-section">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="col-md-12 col-12 mb-3 d-none">
                        <div class="form-group">
