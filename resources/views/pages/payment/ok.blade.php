...
<div class="shopping-cart section">
    <div class="container text-center">
        <h4 class="mb-4"><i class="text-success fa fa-check"></i> {{ __('تم قبول الدفع بنجاح') }}</h4>
        @if(session('success'))
    ...
    <div class="row mb-4" >
        <div class="col-12 text-center">
            <div class="card card-body">
                <h1 class="os-text mb-4 mt-4">شكرا لكم</h1>
            </div>
        </div>
    </div>
    <a href="/الإعلانات/{{ request('id_ads') }}" class="btn btn-primary text-white">{{ __('المواصلة') }}</a>
