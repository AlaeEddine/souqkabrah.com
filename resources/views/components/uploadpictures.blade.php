...
<div class="inputs<?php echo $filename; ?>"></div>
@section('scripts')
@parent
...
myDropzone<?php echo $filename; ?>.on("successmultiple", function(files, response<?php echo $filename; ?>) {
    $('.inputs<?php echo $filename; ?>').append(response<?php echo $filename; ?>);
